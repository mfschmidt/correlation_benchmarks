...
print("Running one-out correlations with scipy...")
seconds = timeit.timeit(stmt='shorts = naive_scipy_correlations(va, vb)', number=1, globals=globals())
actual_r = pearsonr(va, vb)[0]
